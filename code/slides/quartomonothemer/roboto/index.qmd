...
title-slide-attributes:
    data-background-image: "https://source.unsplash.com/hDyO6rr3kqk"
execute:
    echo: false
    warning: false
    message: false
...
style_mono_quarto(
  ...
  path_scss = here::here("code/slides/quartomonothemer/roboto/custom.scss")
)
...
sum_titanic |>
  ...
  geom_tile() +
  geom_text(aes(label = lbl), color = darkgray, family = font_text) +
